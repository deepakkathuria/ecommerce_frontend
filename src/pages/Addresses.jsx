...
const Addresses = () => {
  ...
  const fetchAddress = async () => {
    ...
    try {
      const response = await fetch(apiUrl(`/orders/${orderId}/address`), {
  ...
  const handleRemove = async () => {
    ...
    try {
      const response = await fetch(apiUrl(`/orders/address/${address.address_id}`), {
        method: "DELETE",
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const handleSaveAddress = async (e) => {
    ...
    try {
      let response;
      if (address) {
        response = await fetch(apiUrl(`/orders/address/${address.address_id}`), {
          method: "PATCH",
          headers: {
        ...
        response = await fetch(apiUrl(`/orders/${orderId}/address`), {
          method: "POST",
          headers: {
            Authorization: `Bearer ${token}`,
            "Content-Type": "application/json",
