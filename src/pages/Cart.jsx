...
import { addCart, delCart, clearCart, syncCart } from "../redux/action";
    ...
    return (
      <div className="cart-empty-container">
        <div className="cart-empty-content">
          ...
          <Link href="/product" className="cart-empty-btn">
            Start Shopping
          </Link>
        </div>
      </div>
  ...
  const CartItem = ({ item }) => {
    ...
    useEffect(() => {
      const fetchStock = async () => {
        try {
          const response = await fetch(apiUrl(`/product/${item.id}`));
      ...
      <div className="cart-item-card">
        ...
        <div className="cart-item-content">
          <div className="cart-item-image-wrapper">
            <Link href={`/product/${generateProductSlug(item.title || item.name, item.id)}`}>
              <img
          ...
          <div className="cart-item-details">
            <Link href={`/product/${generateProductSlug(item.title || item.name, item.id)}`} className="cart-item-brand">
              {item.category || item.categoryName || "ZAIRI"}
            </Link>
            <Link href={`/product/${generateProductSlug(item.title || item.name, item.id)}`} className="cart-item-title">
              {item.title}
            </Link>
